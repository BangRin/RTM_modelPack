...
public class BezierCurveGenerator : Singleton<BezierCurveGenerator>
{
    ...
    public void SplitRail()
    {
        ...
        Vector3[] controlPoints = selectRail.GetControlPoints(); // 원래 RailLine의 제어점 가져오기
    ...
    // De Casteljau 알고리즘을 사용하여 베지어 곡선의 특정 t 값에서의 점을 계산합니다.
